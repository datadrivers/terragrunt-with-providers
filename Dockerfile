ARG TERRAFORM_PROVIDER_NEXUS_VERSION=1.10.2
...
ARG TERRAFORM_PROVIDER_NEXUS_VERSION
ENV TERRAFORM_PROVIDER_NEXUS_CHECKSUM="5e9b8196eb98a3badf6ff094dafe197eb995537e433be307054271175e34cb19"
ENV TERRAFORM_PROVIDER_NEXUS_ARCHIVE_FILENAME=terraform-provider-nexus_v${TERRAFORM_PROVIDER_NEXUS_VERSION}_linux_amd64.tar.gz
ARG TERRAFORM_PROVIDER_NEXUS_FILENAME=terraform-provider-nexus_v${TERRAFORM_PROVIDER_NEXUS_VERSION}
ENV TERRAFORM_PROVIDER_NEXUS_URL=https://github.com/datadrivers/terraform-provider-nexus/releases/download/v${TERRAFORM_PROVIDER_NEXUS_VERSION}/${TERRAFORM_PROVIDER_NEXUS_ARCHIVE_FILENAME}
...
# add custom providers for TF 0.13 requires folder structure: HOSTNAME/NAMESPACE/TYPE/VERSION/TARGET
COPY --from=TERRAFORM_PROVIDER_NEXUS-BUILD /terraform-provider-nexus_* /root/.terraform.d/plugins/registry.terraform.io/datadrivers/nexus/${TERRAFORM_PROVIDER_NEXUS_VERSION}/linux_amd64/
